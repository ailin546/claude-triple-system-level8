---
name: ecc-blueprint
description: Use when planning a complex multi-PR or multi-session engineering project that needs a step-by-step construction plan with self-contained per-step context briefs. DO NOT use for tasks completable in a single PR or under 3 tool calls.
---
